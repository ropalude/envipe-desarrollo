...
#define myAppName  "IktanMovil_Produccion_Envipe"
...
SourceDir={#mySource}
OutputBaseFilename=PO_ENVIPE_[ENTIDAD]_IktanMovil_{#myVersion}
...
;Name: figura\ise;            Description: Observador;                  Flags: exclusive; Types: custom;
Name: figura\jefe;           Description: Jefe de entrevistadores [JE];Flags: exclusive; Types: custom;
Name: figura\enumerador;     Description: Entrevistador;               Flags: exclusive; Types: custom; 
...
Source: envipe\instalador\N0.inegi;      DestDir: {app};                   DestName: config.inegi;                Components: figura\SCentral;       Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
Source: envipe\instalador\N3.inegi;      DestDir: {app};                   DestName: config.inegi;                Components: figura\SRegional;      Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
;Source: envipe\instalador\N5.inegi;      DestDir: {app};                   DestName: config.inegi;                Components: figura\ise;            Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
Source: envipe\instalador\N6.inegi;      DestDir: {app};                   DestName: config.inegi;                Components: figura\jefe;     Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
Source: envipe\instalador\N7.inegi;      DestDir: {app};                   DestName: config.inegi;                Components: figura\enumerador;     Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
...
Source: envipe\instalador\fotosEnvipe\[ENTIDAD]\img01.jpg;      DestDir: {app}\Recursos\;                   DestName: img01.jpg;                Components: aplicacion;     Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
Source: envipe\instalador\fotosEnvipe\[ENTIDAD]\img02.jpg;      DestDir: {app}\Recursos\;                   DestName: img02.jpg;                Components: aplicacion;     Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
Source: envipe\instalador\fotosEnvipe\[ENTIDAD]\img03.jpg;      DestDir: {app}\Recursos\;                   DestName: img03.jpg;                Components: aplicacion;     Permissions: users-modify; Flags: overwritereadonly; Attribs: ReadOnly Hidden;
...
;Source: notify.wav;                    DestDir: {app};                 DestName: notify.wav;                  Components: aplicacion; Permissions: users-modify; Flags: onlyifdoesntexist overwritereadonly restartreplace; Attribs: ReadOnly Hidden;
...
const
    ...
    //FABRICANTEN         = 'INEGI - SOPORTE TECNICO CGI (13/ENERO/2017)';
