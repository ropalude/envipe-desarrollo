...
implementation
uses UStrHashMap,SysUtils,UDaoFactory, Ulibrerias, UISelect, CLevantamiento, UCadenas, CEstatusEnvipe;
...
begin
	try
      ...
      params.put('condicion', 'tr_movimientos.id_estatus not in ('+ estatusEnvipe.ELIMINADO_REINICIO+ ','+ estatusEnvipe.FINALIZADO+','+ estatusEnvipe.LIBERADO_DE_CAMPO+','+ estatusEnvipe.DESPLAZAMIENTO_INCOMPLETO+','+estatusEnvipe.DESPLAZAMIENTO_COMPLETO+')'
      + ' and tr_muestras_envipe2016.cod_res_viv not in (' + comillas('01')+ ','+ comillas('02') +')');
